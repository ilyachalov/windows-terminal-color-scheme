...
#
#   Добавление 1 (18x9): я добавил к исходной таблице 2 строки
...
#   имела размер 16x8.)
#
#   Добавление 2 (34х9): кроме вышеперечисленного я добавил
#   16 строк для управляющих кодов 100-107 (яркий фон).
#
